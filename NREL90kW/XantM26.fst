------- OpenFAST 3.4.1 INPUT FILE ------------------------------------------------
The Floating Wind Technology Co. - Nov. 2023. based on OpenFAST 3.4.1 and translated from D:\RRD_ENGINEERING\PROJECTS\WE202302_dWAM\PM\Deliverable07\ANALYSIS\XANT_HAWC2\htc_master\master_V2_XFOIL26.htc
---------------------- SIMULATION CONTROL --------------------------------------
False               	Echo            - Echo input data to <RootName>.ech (flag)
"FATAL"             	AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
1101 400 681 100                  	TMax            - Total run time (s)
0.005 0.0001                 	DT              - Recommended module time step (s) 0.0001 for BD
2                   	InterpOrder     - Interpolation order for input/output time history (-) {1=linear, 2=quadratic}
0                   	NumCrctn        - Number of correction iterations (-) {0=explicit calculation, i.e., no corrections}
99999               	DT_UJac         - Time between calls to get Jacobians (s)
1000000             	UJacSclFact     - Scaling factor used in Jacobians (-)
---------------------- FEATURE SWITCHES AND FLAGS ------------------------------
1 2                   	CompElast       - Compute structural dynamics (switch) {1=ElastoDyn; 2=ElastoDyn + BeamDyn for blades}
...
1.225     	 	AirDens        - Air density (kg/m^3)irDens        - Air density (kg/m^3)
1025            WtrDens     - Water density (kg/m^3)
1.464e-05       KinVisc     - Kinematic viscosity of working fluid (m^2/s)
340             SpdSound    - Speed of sound in working fluid (m/s)
101500          Patm        - Atmospheric pressure (Pa) [used only for an MHK turbine cavitation check
...
---------------------- INPUT FILES ---------------------------------------------
"XantM26_ED.dat"    	EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"XantM26_BeamDyn_Smoothed_00.dat"     BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"XantM26_BeamDyn_Smoothed_00.dat"     BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"XantM26_BeamDyn_Smoothed_00.dat"     BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"XantM26_IFW.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"XantM26_AD.ipt"    	AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"XantM26_SD.dat"    	ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
0.05 "default"  		DT_Out          - Time step for tabular output (s) (or "default")
