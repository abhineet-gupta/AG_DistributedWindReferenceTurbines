...
0.005           DT              - Recommended module time step (s) 0.0001 for BD
...
---------------------- INPUT FILES ---------------------------------------------
"NREL90kW_ED.dat"          EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
"NREL90kW_BeamDyn.dat"     BDBldFile(1)    - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"NREL90kW_BeamDyn.dat"     BDBldFile(2)    - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"NREL90kW_BeamDyn.dat"     BDBldFile(3)    - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"NREL90kW_IFW.dat"         InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"NREL90kW_AD.ipt"          AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"NREL90kW_SD.dat"           ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
...
30              LinTimes      - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
